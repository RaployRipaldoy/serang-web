...
<body>
    <h1 style="text-align:center;">Laporan Data Perlengkapan Jalan</h1>
    ...
    <table style="text-align:center;">
        ...
        <tbody>
            <?php $no = 1; foreach ($perlengkapan as $item): ?>
            <tr>
                <td><?= $no++ ?></td>
                ...
                <td>
                    <?php if (!empty($item['foto_perlengkapan'])): ?>
                        <img src="<?= base_url('uploads/' . $item['foto_perlengkapan']) ?>" width="100">
                    <?php endif; ?>
                </td>
            </tr>
            <?php endforeach; ?>
